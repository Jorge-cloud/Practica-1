 ...
 * @author Jorge
 */
@WebServlet(name = "CalculaEdadGet", urlPatterns = {"/CalculaEdadGet"})
public class CalculaEdadGet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</from>");
            out.println("<h2>Ingrese: ?fecha=año de nacimiento</h2><br>");
            
            int fecha=Integer.parseInt(request.getParameter("fecha")); 
            if (fecha!=0) {
                out.println("Su edad es: <strong> "+(2021-fecha)+"</strong> años<br>");
            }else{
